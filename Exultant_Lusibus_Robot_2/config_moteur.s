...
VITESSE			EQU		0xD1	; Valeures plus petites => Vitesse plus rapide exemple 0x192
								; Valeures plus grandes => Vitesse moins rapide exemple 0x1B2
						
VITESSE2		EQU		0x155
	
VITESSE3		EQU		0x04			;0xC1
		...
		EXPORT	MOTEUR_INIT_DROITE ; Demi-tour en 4 mesures
		EXPORT	MOTEUR_INIT_RAPIDE ; Demi-tour en 1 mesure
		EXPORT  MOTEUR_INIT_GAUCHE ; Demi-tour en 4 mesures
...
MOTEUR_DROIT_AVANT
		...
		mov	r0, #2
		str	r0,[r6]
		str r3,[r4] ; allume la led droite à chaque fois que la roue droite avance
		BX	LR
...
MOTEUR_GAUCHE_AVANT
		...
		mov	r0, #0
		str	r0,[r6]
		str r2,[r5]; allume la led gauche à chaque fois que la roue gauche avance
		BX	LR		
